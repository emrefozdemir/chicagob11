...
public class AmazonDropdownAllOptionSelection {
    public static void main(String[] args) {
        ...
        departmentsDropdownInSearchList.selectByVisibleText("Courses");
        System.out.println(departmentsDropdownInSearchList.getFirstSelectedOption().getText());
